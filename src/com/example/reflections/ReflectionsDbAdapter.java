...
public class ReflectionsDbAdapter {
    ...
    private static final String TAG = "ReflectionsDbAdapter";
     ...
     */
    public ReflectionsDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }
     ...
     */
    public ReflectionsDbAdapter open() throws SQLException {
     ...
     */
    public boolean deleteResponse(long rowId) {
     ...
     */
    public Cursor fetchResponse(long rowId) throws SQLException {
