...
public class reflections extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	quotes = new Quote[] {
    			...
    			new Quote("Letting go of your desires and to be content doesn't include letting go of your dreams and goals. It just means that you see your dreams and goals as \"only\" dreams and goals.\n\nDropping your desires and being content is like having a wonderful 3 course meal and your dreams and goals become like the little dessert afterwards.\n\nBut if you make your dreams and goals your primary desires, you aren't eating properly with normal food and going straight for dessert.\nYou will then wonder after you have your dessert why you still feel hungry and discontent.",1),
    			...
    			new Quote("Sacrificing yourself to help others is like trying to help someone climb a wall by getting them to stand on your shoulders. In the end, you are the one who is stuck at the bottom of the wall. Plus, there are so many other people that need help you will never climb the wall because you are so busy helping everyone else climb and you will be stuck at the bottom. \n\nBut if you put yourself first, by initially climbing on the wall yourself and securing your position so you cannot fall, then you can extend a hand to others to help them climb up onto the wall. In that scenario, both of you are up on the wall and you can continue to help others help climb the wall without hurting yourself. And because you are looking after yourself, you will find that helping others becomes more efficient and your capacity to help increases.",1),
    			...
    			new Quote("Mirror\nYou get into my nerves,\nThat irritating trait!\nMaking my blood boil,\nYou have qualities I hate.\n\nI deem you an annoyance,\nSomeone I should ignore.\nThat putrid smell of arrogance\nIs rotten to the core.\n\nI should turn my back against you,\nBut took a glimpse once more.\nAnd that's when I started seeing\nSomething I’ve not seen before.\n\nI look a little closer\nTo examine what I see\nAnd the truth hit me that instant\nThat you're reflecting me!\n\nI am the exact same person\nWhom I’ve claimed to detest.\nIn my arrogance, I fooled myself\nThought I was better than the best.\n\nI was quick to hate others\nAnd went on judging too\nWithout seeing that I’m doing\nThe things I hate to do.\n\nI bow my head in shame\nAs I learnt something true:\nThat the cause of my hostility\nIs that I see my faults in you.\n\nSo before I point my fingers,\nOr decide to just ignore,\nThe ones who has annoyed me\nI take a better look once more.\n\nAnd as I see their weaknesses\nI too can see my faults\nAnd try then to amend it\nTo a trait I can exalt.\n\nBy: TALL",1),
