...
public class reflections extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	quotes = new Quote[] {
    			...
    			new Quote("Think of something or someone you are attached to; in other words, something or someone without which or without whom you think you are not going to be happy. It could be your job, your career, your profession, your friend, your money, whatever.\n\nAnd say to this object or person, “I really do not need you to be happy. I’m only deluding myself in the belief that without you I will not be happy. But I really don’t need you for my happiness; I can be happy without you. You are not my happiness, you are not my joy.”",1),
